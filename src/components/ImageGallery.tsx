...
import { GalleryData, ImageType } from '@data/GalleryData'
...
const ImageGallery: React.FC = () => {
  ...
  return (
    <section id="portfolio" className="w-full h-full bg-black text-white py-28">
      ...
      <div className="grid grid-cols-4 md:grid-cols-7 text-xs md:text-base font-bold mt-8 md:mt-16 mx-6">
        {imageTypes.map(type => (
          <button
            key={type}
        ...
        <button className="text-center col-span-2 md:col-span-1 py-1 md:py-4 font-bold bg-yellow text-black uppercase border-4 border-transparent hover:bg-black hover:text-white hover:border-yellow duration-300" 

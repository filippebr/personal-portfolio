  ...
  return (
    <section id="portfolio" className="w-full h-full bg-black text-white py-28">
      ...
      <div className="grid grid-cols-3 justify-center items-center">
        <button onClick={() => filterImagesByType('web')}>Web</button>
        <button onClick={() => filterImagesByType('graphic')}>Graphic</button>
        <button onClick={() => setFilteredImages(images)}>Reset</button>
      </div>
